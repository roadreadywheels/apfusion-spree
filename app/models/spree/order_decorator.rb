			...
			p "response called"*8
		 		...
		 		begin
		 			...
		 			unless apf_order.present?
					  ...
					  order["ship_address"]["phone"].present? ? order["ship_address"]["phone"] : order["ship_address"]["phone"] = "888-790-5899"
					  order["bill_address"]["phone"].present? ? order["bill_address"]["phone"] :  order["bill_address"]["phone"] = "888-790-5899"
					  ...
					  order["ship_address"].delete('country')
					 	...
					 	p "================"*20
					 	p orders_attributes = {'bill_address_attributes'=>bill_address,'ship_address_attributes'=>ship_address,'email'=>order['user_email'],'special_instructions'=>order['special_instructions'],'apfusion_order_id'=>order['id'],'apfusion_completed_at'=>order['completed_at'],'user_id' => order['rrw_user_id']}
					 	p "================"*20
