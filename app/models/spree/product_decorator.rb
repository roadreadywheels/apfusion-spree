module Spree
  module ProductDecorator
    def self.prepended(base)
    	base.validates :apfusion_product_id, :uniqueness => true, :on => :update, if: :apfusion_product_id?
		  ...
		  def base.sync_orders(options = {})
			...
			def base.create_product_properties
				Spree::Property.create_all_property
			...
			def base.create_product_to_apfusion_having_duplicate_ids
			...
			def base.update_stock_to_apf
				Spree::StockItem.find_each(batch_size: 400) do |stock_item|
					if stock_item.apfusion_stock_item_id.present?
						SpreeApfusion::StockItem.update(stock_item)
					else
						SpreeApfusion::StockItem.create(stock_item)
